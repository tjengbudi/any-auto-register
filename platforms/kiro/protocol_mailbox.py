    ...
    def run(
        ...
        *,
        ...
        if not identity:
            ...
            # was: raise RuntimeError("create-identity失败")
        ...
        if not signup_registration:
            ...
            # was: raise RuntimeError("signup registration失败")
